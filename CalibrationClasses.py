...
import CalibrationSettings as CalibrationSettings
...
class Calibration:
    def __init__(self):
        ...
        self._cohortIDs = range(CalibrationSettings.POST_N)   # IDs of cohorts to simulate
    ...
    def sample_posterior(self):
        ...
        multiCohort = SurvivalCls.MultiCohort(
            ...
            pop_sizes=[CalibrationSettings.SIM_POP_SIZE]*CalibrationSettings.POST_N
        )
        ...
        for cohort_id in self._cohortIDs:
            ...
            weight = stat.binom.pmf(
                k=CalibrationSettings.OBS_SURV, n = CalibrationSettings.OBS_N, p = proportion,
                loc = 0)
