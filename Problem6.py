...
OBS_SURV = 800   # estimated mean survival time
...
class Calibration:
    ...
    def sample_posterior(self):
        ...
        for cohort_id in self._cohortIDs:
            ...
            proportion = multiCohort.get_5yr_survtime(cohort_id) ## modify to get 5 year survival

            weight = stat.binom.pmf(
                k=OBS_SURV, n = OBS_N, p = proportion,
                loc = 0)
...
#PROBLEMS4/5:
# The estimated annual mortality probability and the 95% credible interval is: 0.0701 (0.0589, 0.0823)
# Mean survival time and 95% projection interval: 14.4397 (12.6221, 16.6210)
#PROBLEM 6:
#The estimated annual mortality probability and the 95% credible interval is: 0.0694 (0.0603, 0.0794)
#Mean survival time and 95% projection interval: 14.2730 (12.5028, 16.0790)

print('When recalibrating the model in Problem 6, the 95% credible interval becomes slightly narrower.')
print('The projection interval also becomes narrower.')
