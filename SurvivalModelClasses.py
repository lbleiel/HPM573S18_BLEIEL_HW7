...
############## PROBLEM 1 ###########################################
    def get_5yr_survtime(self):
        num_people = 0
        for value in self._survivalTimes:
            if value > 5.0:
                num_people+=1
        five_year_percent = num_people / len(self._survivalTimes)
        return five_year_percent
...
class MultiCohort:
    ...
    def simulate(self, n_time_steps):
        ...
        for i in range(len(self._ids)):
            ...
            self._5yearSurvivals.append(cohort.get_5yr_survtime())
    ...
    def get_5yr_survtime(self, cohort_index):
        return self._5yearSurvivals[cohort_index]
